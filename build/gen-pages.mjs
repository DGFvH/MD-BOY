...
${TOOLS.map((t) => `          <li><a href="/${t.slug}">${esc(t.h1)}</a><p>${esc(t.description)}</p></li>`).join('\n')}
        ...
        <h2 id="connect">Connect Hashlite to your AI assistant</h2>
        <p>Add Hashlite as a connector (MCP server) and your assistant can open the documents it writes in the editor. <a href="/connect">How to connect it</a>.</p>
